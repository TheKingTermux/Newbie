...
figlet Newbie1 | lolcat

echo "_____________________________________________________________"
echo "Tools    : Kumpulan Newbie Tools $white                         " |lolcat
echo "Createdby: TheKingTermux $white                                      " |lolcat
echo "Contact  : 087705736634   $white                             " |lolcat
echo "_____________________________________________________________"
...
6) echo Thanks For Using My Script ;-) .
echo "created by : TheKingTermux" | lolcat
echo Thanks Too : ALLAH SWT.
echo See You Later . GoodByee.
exit
;;
